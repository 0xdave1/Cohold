...
export function DeactivateAdminModal({ open, loading = false, onClose, onConfirm }: DeactivateAdminModalProps) {
  return (
    <BaseModal open={open} title="Deactivate admin" onClose={onClose}>
