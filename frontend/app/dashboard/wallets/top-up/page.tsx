    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 space-y-4">
        <p className="text-sm text-slate-300 leading-relaxed">
          Wallet funding is processed only through secure Flutterwave checkout. Your balance updates after the
          payment is verified on our servers (not when you leave checkout).
        </p>
        <p className="text-sm text-slate-400">
          Bank transfer via virtual account is not available here; use the wallet page to start checkout.
        </p>
        <Link
