...
export class InvestmentService {
  ...
  async getInvestmentReceipt(id: string, userId: string) {
    ...
    return {
      ...
      yieldIsProjected: inv.property.yieldIsProjected,
      yieldBasis: inv.property.yieldBasis,
      termMonths: inv.property.termMonths,
      listingType: inv.property.listingType,
      expectedReturnDisclosure: inv.property.expectedReturnDisclosure,
      riskDisclosure: inv.property.riskDisclosure,
